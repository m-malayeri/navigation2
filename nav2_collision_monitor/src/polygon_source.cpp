...
// Port to Humble
#include "nav2_collision_monitor/nav2_msgs_tf2.hpp"
...
void PolygonSource::configure()
{
  ...
  data_sub_ = node->create_subscription<nav2_msgs::msg::PolygonInstanceStamped>(
    source_topic, qos,
  ...
  std::vector<Point> & data)
{
  ...
  data_.erase(
    std::remove_if(
      ...
      [this, curr_time](const nav2_msgs::msg::PolygonInstanceStamped & polygon_stamped) {
  ...
  for (const auto & polygon_instance : data_) {
    ...
    nav2_msgs::msg::PolygonStamped poly_out, polygon_stamped;
...
void PolygonSource::convertPolygonStampedToPoints(
  const nav2_msgs::msg::PolygonStamped & polygon, std::vector<Point> & data) const
{
...
void PolygonSource::dataCallback(nav2_msgs::msg::PolygonInstanceStamped::ConstSharedPtr msg)
{
  auto node = node_.lock();
  if (!node) {
    throw std::runtime_error{"Failed to lock node"};
